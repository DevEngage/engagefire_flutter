...
const IMAGE_LUNGE_DUMBBELL_PATH = "assets/img/lunge-with-dumbbell.jpg";
const IMAGE_PULLUP_PATH = "assets/img/rope-pullup.jpg";
const ICON_LOGO_PATH = "assets/icon/logo.svg";
const ICON_APP_PATH = "assets/icon/icon.png";
